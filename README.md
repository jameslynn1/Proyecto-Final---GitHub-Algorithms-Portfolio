...
---
## **Observaciones**
- Binary search es más eficiente que linear search en arreglos ya ordenados.
- Linear search es lento, pero es una buena introducción a los algoritmos de búsqueda.
- Bubble sort e insertion sort solo se utilizan para arreglos pequeños, o para explicar algoritmos de ordenamiento a principiantes.
- Merge sort y quick sort son de los algoritmos más rápidos de ordenamiento, pero son menos simples, ya que usan recursión.


## **Reflexión**

Durante el curso, aprendimos:
- Cómo crear nuestros propios tipos de variables compuestas
- Usos de los ciclos anidados
- Cómo crear métodos de búsqueda
- Las fortalezas y debilidades de cada algoritmo de búsqueda y ordenamiento
- Diferencias entre variables primitivas y variables de arreglo
